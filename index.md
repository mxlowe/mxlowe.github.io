...
<h3>Latest Research</h3> Similarity-based fusion of MEG-fMRI sound representations in the human brain. Whole-brain fusion shows the emergence and progression of sound representations by correlating spatial data from fMRI with temporal data from MEG.
<p>
...
<br>
		...
		<p>Broadly, his work investigates perception, with a goal to understand how we process the world around us. He uses functional magnetic resonance imaging (fMRI), magneto- and electroencephalography (MEG/EEG), computational neuroscience techniques, and behavioural investigations. 

<p>Currently, his work at MIT involves the investigation of the spatiotemporal neural dynamics underlying auditory processing of various sound sources using MEG, fMRI, and MEG-fMRI similarity-based fusion.</p>
